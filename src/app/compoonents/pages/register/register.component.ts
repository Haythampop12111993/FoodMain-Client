...
export class RegisterComponent {
  AllCountry: { name: string; code: string }[] = [
  ...
  handelRegisterForm() {
    ...
    if (
      this.registerFormData.valid &&
      this.registerFormData.controls.password.value ===
        this.registerFormData.controls.confirmPassword.value
    ) {
      console.log(this.registerFormData.value);
      const userData = {
        name: this.registerFormData.controls.name.value,
        email: this.registerFormData.controls.email.value,
        password: this.registerFormData.controls.password.value,
        address: this.registerFormData.controls.address.value,
        phone: this.registerFormData.controls.phone.value,
        gender: this.registerFormData.controls.gender.value,
      };
